...
// box-border + w-full + max-w-full keep inputs (notably native date inputs on
// iOS) from overflowing their card.
export const fieldClasses =
  "box-border w-full max-w-full rounded-xl border border-black/10 bg-white px-3 py-2 text-sm text-ink " +
